    ...
    //            GET GALLERY  
                ...
                if($image_num >=1){
                    echo "<div class=\"gallery\">";
                        ...
                        echo "<div>";
                        if($image['is_img']==1){
                            $file= "<a href=\"" .$image['file_path'] . "\" title='" .$image['title']. "' class='fancybox' rel=\"group\"><div class=\"img_container\"><img class=\"thumb_avatar\" onerror=\"this.src='img/Tulips.jpg'\"  src=\"".$image['thumb_path']."\"></div></a>";
